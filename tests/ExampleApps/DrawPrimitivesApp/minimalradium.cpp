...
const bool ENABLE_CUBES     = false;
const bool ENABLE_POINTS    = false;
const bool ENABLE_LINES     = false;
const bool ENABLE_VECTORS   = false;
const bool ENABLE_RAYS      = false;
const bool ENABLE_TRIANGLES = false;
const bool ENABLE_CIRCLES   = false;
const bool ENABLE_ARCS      = false;
const bool ENABLE_SPHERES   = false;
const bool ENABLE_CAPSULES  = false;
const bool ENABLE_DISKS     = false;
const bool ENABLE_NORMALS   = false;
const bool ENABLE_POLYS     = false;
const bool ENABLE_LOGO      = false;
